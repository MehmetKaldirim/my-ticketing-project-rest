...
public class UserController {
    ...
    public ResponseEntity<ResponseWrapper> getUsers(){
        ...
        return ResponseEntity.ok(new ResponseWrapper("All user are successfully retrieved",userDTOList, HttpStatus.OK));
    }
...
//        return ResponseEntity.status(HttpStatus.NO_CONTENT).body(new ResponseWrapper("User is successfully created",HttpStatus.CREATED));
        ...
        //204 - HttpStatus.NO_CONTENT means without body
    }
}
